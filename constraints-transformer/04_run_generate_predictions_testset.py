...
parser = argparse.ArgumentParser(description="Process to get predictions of kirans model with with optional settings.")
...
for i in range(times_to_run):
    prediction_output_dir = f'data/evaluation/{dataset}/test{i+1}/{model_name}_{model_checkpoint}/'
